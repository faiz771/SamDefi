              ...
              <div class="card">
                <div class="card-body">
                  ...
                  if(isset($CEAction) && $CEAction == "save") {
                    ...
                    if(empty($expire_uncompleted_time) or empty($title) or empty($description) or empty($keywords) or empty($name) or empty($url) or empty($infoemail) or empty($supportemail)) {
                        ...
                        $update = $db->query("UPDATE ce_settings SET title='$title',description='$description',keywords='$keywords',name='$name',url='$url',infoemail='$infoemail',supportemail='$supportemail'");
