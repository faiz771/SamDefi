...
function ce_PF_PayPal($order_id) {
	...
	$return .= '<script type="text/javascript" src="'.$settings["url"].'app/templates/LightExchanger/assets/js/jquery-1.10.2.js"></script>';
...
function ce_PF_Stripe($order_id) {
	...
	var handler = StripeCheckout.configure({
		...
		image: "'.$settings[url].'app/templates/LightExchanger/assets/img/site_logo_2.png",
		locale: "auto",
...
function CP_CreateOrder($gateway_id,$order_id) {
	...
	$req = array(
		...
		'currency1' => gatewayinfo($gateway_id,"g_field_5"),
		'currency2' => gatewayinfo($gateway_id,"g_field_5"),
