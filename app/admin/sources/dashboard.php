                        ...
                        if($query->num_rows>0) {
                          while($row = $query->fetch_assoc()) {
                            ...
                            <tr>
                              ...
                              <td><?php if($row['uid']) { ?><a href="./?a=users&b=edit&id=<?php echo $row['uid']; ?>"><?php if(idinfo($row['uid'],"first_name")) { echo idinfo($row['uid'],"first_name")." ".idinfo($row['uid'],"last_name"); } else { echo idinfo($row['uid'],"email"); } ?></a><?php } else { echo 'none'; } ?></td>
