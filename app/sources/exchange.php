...
$tpl->set("currency_from",gatewayinfo($from,"currency"));
$tpl->set("currency_to",gatewayinfo($to,"currency"));
...
if(isset($CEAction) && $CEAction == "exchange") {
    ...
    $currency_from = gatewayinfo($from,"currency");
    $currency_to = gatewayinfo($to,"currency");
