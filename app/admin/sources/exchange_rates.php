    ...
    <div class="row">
            <div class="col-md-12 col-lg-12">
                ...
                <div class="alert alert-info">
                        ...
                        To update automatically exchange rates you must add a CRON job which to be run every 1, 2, 3, 5 or 10 minutes.<br/>
                        Command line: <b>/usr/bin/php -q /home/your username/public_html/app/cron/update_rates.php</b> or <b>curl "<?php echo $settings['url']; ?>app/cron/update_rates.php"</b>
                    </div>
                    </div>
            <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
